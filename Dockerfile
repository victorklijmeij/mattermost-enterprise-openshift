...
ENV MATTERMOST_VERSION_SHORT 460
...
RUN chmod 777 /opt/mattermost/config/config.json && \
    mkdir /opt/mattermost/data /opt/mattermost/plugins && \
    chmod 777 /opt/mattermost/logs/ /opt/mattermost/data /opt/mattermost/plugins
